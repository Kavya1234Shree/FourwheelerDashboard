...
export class FourwheelerdriverComponent implements OnInit {
 ...
 totalRec : number;
  ...
  ngOnInit() {
    const resp = this.httpClient.get('https://apis.zeigerapp.in/api/driverfour');
...
deleteRow(phone){
 ...
 let resp=this.httpClient.get('https://apis.zeigerapp.in/api/driverfour/delete?phone='+phone);
