...
public driver_online: any;
 ...
 pubnub = new PubNubAngular();
  ...
  pubnub.subscribe({
     ...
     ////////online//////////
    let resp= this.http.get("https://apis.zeigerapp.in/api/driver-position/driver-online")
    resp.subscribe((data: any)=>{
       console.log(data) ;
 this.driver_online= data.count ;
 console.log(this.driver_online);
      ...
      ////////offline//////////
      let response= this.http.get("https://apis.zeigerapp.in/api/driver-position/driver-offline")
 ...
 ////////two-wheel-registered-driv//////////
        let respons= this.http.get("https://apis.zeigerapp.in/api/driver-registration/driver-two")
...
let respon= this.http.get("https://apis.zeigerapp.in/api/driver-registration/driver-four")
...
let respo= this.http.get("https://apis.zeigerapp.in/api/transaction/picked")
...
let res= this.http.get("https://apis.zeigerapp.in/api/transaction/accept")
...
console.log(this.picking_up);
  ...
  let ress= this.http.get("https://apis.zeigerapp.in/api/nodriver/fourcount")
      
ress.subscribe((data: any)=>{
   console.log(data) ;
this.nodriv= data.count ;
console.log(this.nodriv);
  }  )
