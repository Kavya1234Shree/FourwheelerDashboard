...
if(event.target.checked)
{
  ...
  ngOnInit() {
   let resp = this.http.get("https://apis.zeigerapp.in/api/deactivate/id?driver_uuid="+this.driver_uuid);
  ...
  //                     this.http.post('http://165.22.219.195:2390/api/1.0/driver-fourregistration',fd)
