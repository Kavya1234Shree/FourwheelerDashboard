...
//  this.PubNub = pubnub
  ...
  ngOnInit() {
    ...
    let resp = this.http.get("https://apis.zeigerapp.in/api/vendor-reg/id?vendor_uuid="+this.vendor_uuid);
    resp.subscribe((data)=>{
    this.user=data;
   ...
   this.GST_certificate='https://apis.zeigerapp.in/'+data['GST_certificate']
